...
id{end+1} = 0; subs{end+1}=[1,50,1];subc{end+1}=[-1,1,-1];subt{end+1}=[1,1,1];
               %indxem{end+1}=[1,100,1,1,1,200];
               indxem{end+1}=[];
               indxkp{end+1}=[];
id{end+1} = 0; subs{end+1}=[50,1,1];subc{end+1}=[1,-1,-1];subt{end+1}=[1,1,1];
...
%                    squeeze(z{n}), ...
%                    squeeze(v{n}));
       sid{n}=surf(squeeze(lon{n}(:,:,res:end)), ...
                   squeeze(clat{n}(:,:,res:end)), ...
                   squeeze(R{n}(:,:,res:end)-6371000), ...
                   squeeze(v{n}(:,:,res:end)));
    else
...
%                    flipdim(squeeze(v{n}),3));
        sid{n}=surf(flipdim(squeeze(lon{n}(:,:,res:end)),3), ...
                   flipdim(squeeze(clat{n}(:,:,res:end)),3), ...
                   flipdim(squeeze(R{n}(:,:,res:end)-6371000),3), ...
                   flipdim(squeeze(v{n}(:,:,res:end)),3));
    end
