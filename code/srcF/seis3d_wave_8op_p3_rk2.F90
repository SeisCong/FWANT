...
call macdrp_RK_beg(secRKa(1),secRKb(1))
call abs_RK_beg(secRKa(1),secRKb(1))
! the 2th stage
call set_cur_time(ntime,secRKa(1))
call macdrp_LxF_LyF_LzF
call abs_LxF_LyF_LzF
  call src_stress(hTxx,hTyy,hTzz,hTxy,hTxz,hTyz,ntime,secRKa(1),stept)
  call src_force(hVx,hVy,hVz,ntime,secRKa(1),stept)
call macdrp_RK_fin(secRKb(2))
call abs_RK_fin(secRKb(2))
#ifdef WITHQS
 call atten_graves
#endif
