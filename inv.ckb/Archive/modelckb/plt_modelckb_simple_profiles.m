...
subplot(2,1,1);
h1=image(squeeze(x(:,1,1))',squeeze(z(1,1,:))',vplotck');
h1.CDataMapping='scaled';
%h.AlphaData=amaskcut;
colormap('jetwr'); 
hcbar1=colorbar('eastoutside');
...
%colorbar;
ylim([5 100]);
title(['(a) Input model: N-S at latitude= ' num2str(y(1,ny,1)-360,3)]);
set(gca,'YDir','reverse','Fontsize',12)
...
%colorbar;
ylim([5 100]);
title(['(b) Recovered model: N-S at longitude= ' num2str(y(1,ny,1)-360,3)]);
set(gca,'YDir','reverse','Fontsize',12)