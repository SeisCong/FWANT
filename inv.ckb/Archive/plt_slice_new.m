...
minlon=234; maxlon=248; minlat=37.5;maxlat=51;
...
%subplot(1,3,ncmp+1); 
if ncmp==1
subplot('Position',[0.35 0.2 figwid figheight]); 
elseif ncmp==2
subplot('Position',[0.69 0.2 figwid figheight]);
end
...
subplot('Position',[0.05 0.2 figwid figheight]); 
hold on, box on, axis on,
set(gcf,'renderer','zbuffer');
pcolor(YS,XS,squeeze(m(:,:,end)));
[clon,clat]=textread('/home/haiying/Proj/cascadia/misc/PNWcoast_revised.dat','%f %f');
plot(clon+360,clat,'k.','MarkerSize',2);
state=[];
load /home/haiying/Proj/cascadia/misc/us_states.mat
